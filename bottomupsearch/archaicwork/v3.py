...
arithmetic_input_output_examples = [
    ...
    # [([1,4,9], 14), ([3,7,2], 12), ([3,9,9], 21), ([4,5,6], 15)], # add 3 numbers
    # [([1,4,9], 6), ([3,7,2], -2), ([3,9,9], 3), ([4,5,6], 5)], # add and subtract every other number
    ...
    # TODO: INVESTIGATE WHY IT TAKES LONGER TO SYNTHESIZE 2 PROGRAMS TOGETHER VS SYNTHESIZING THEM SEPARATELY (i think it still works but it just much longer and idk why)
...
print(len(arithmetic_input_output_examples))
for task_examples in tqdm(arithmetic_input_output_examples):
    if len(programs_found) == len(arithmetic_input_output_examples):
        ...
        for program in programs_found:
            print(program)
        print("DONE")
        print("ENDING FROM TASK EXAMPLES LOOP")
        exit()

    # print("STARTING A NEW TASK")


    print("Currently, we have found these programs so far: ", programs_found)

    E = {1: []}
    results_seen = set()

    for io_example in tqdm(task_examples):
    ...
    # Add the constants numbers 1 to 10 to our arithmetic DSL
    for i in range(1, 10):
        ...
        for operation_tuple in operations:
            ...
            if len(programs_found) == len(arithmetic_input_output_examples):
                ...
                for program in programs_found:
                    print(program)
                print("DONE")
                print("ENDING FROM OPERATION TUPLE LOOP")
                exit()
            ...
            for arg_tuple in A:
                if len(programs_found) == len(arithmetic_input_output_examples):
                    ...
                    for program in programs_found:
                        print(program)
                    print("DONE")
                    print("ENDING FROM ARG TUPLE LOOP")
                    exit()
                ...
                if len(programs_found) == len(arithmetic_input_output_examples):
                    ...
                    for program in programs_found:
                        print(program)
                    print("DONE")
                    print("ENDING FROM ALL CORRECT LOOP")
                    exit()
